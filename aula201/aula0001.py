...
# Printa a Versão do PyDide6 >>> 6.7.2
print('PySide Version:', PySide6.__version__) # type: ignore

# Printa a versão do Qt usada para compilar o PySide6 >>> 6.7.2
print('QtCore Version:', PySide6.QtCore.__version__) # type: ignore
