...
class MyWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        # Botão 2
        self.botao2 = self.make_button('Botão 2', 40)

        # Botão 3
        self.botao3 = self.make_button('Botão 3', 40)
    ...
    def make_button(self, text, size=80):
        botao = QPushButton(text)
        botao.setStyleSheet(f'font-size: {size}px;')
        return botao
